package Collections.SetOperationChallenge;
...
public class Main {
    public static void main(String[] args) {
        ...
        Comparator<Task> taskByPriority = Comparator.comparing(Task::getPriority);
        Set<Task> annsTasks = TaskData.getTasks("Ann");
        sortAndPrint("Ann's Tasks", annsTasks);
        sortAndPrint("Ann's Tasks", annsTasks, taskByPriority);
        ...
        sortAndPrint("Unassigned Tasks", unassignedTasks, taskByPriority);
        ...
        sortAndPrint("Assigned to Multiples", overlap, taskByPriority);
        ...
        Comparator<Task> priorityNatural = taskByPriority.thenComparing(Comparator.naturalOrder());
