...
public class TaskData {
    ...
    public static Set<Task> getTasks(String asignee) {

        Set<Task> taskList = new HashSet<>();
        String user = ("ann,bob,carol".contains(asignee.toLowerCase())) ? asignee : null;
        String selectedList = switch (asignee.toLowerCase()) {
            case "ann" -> annsTasks;
            case "bob" -> bobsTasks;
